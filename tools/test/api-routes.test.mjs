...
const expectedRoutes = [
  ...
  'GET /api/v1/admin/config/:id/preview',
  ...
  'POST /api/v1/endgame/season/catch-up',
  'POST /api/v1/endgame/quarters/:playerId/rate',
  'POST /api/v1/endgame/store/:slug/purchase',
  'POST /api/v1/endgame/vote',
